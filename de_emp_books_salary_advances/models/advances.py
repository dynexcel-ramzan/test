...
class EmployeeAdvance(models.Model):
    ...
    name = fields.Char('Description', compute='_compute_from_product_id_company_id', store=True, required=True, copy=True,
        states={'draft': [('readonly', False)], 'submit': [('readonly', False)], 'refused': [('readonly', False)]})
    
    ref = fields.Char(string='Reference', required=True, copy=False, readonly=True, index=True, default=lambda self: _('New'))

        
    date = fields.Date(readonly=True, states={'draft': [('readonly', False)], 'submit': [('readonly', False)], 'refused': [('readonly', False)]}, required=True, default=fields.Date.context_today, string="Request Date")
    date_due = fields.Date(readonly=True, states={'draft': [('readonly', False)], 'submit': [('readonly', False)], 'refused': [('readonly', False)]}, required=True, default=fields.Date.context_today, string="Due Date")
    ...
    #job_id = fields.Many2one('hr.job', compute='_compute_from_employee_id', store=True, readonly=False, copy=False, string='Job Position', states={'post': [('readonly', True)], 'done': [('readonly', True)]})
    ...
    advance_type_id = fields.Many2one('hr.employee.advance.type', string='Advance Type', readonly=True, copy=False, states={'draft': [('readonly', False)], 'submit': [('readonly', False)]})
    ...
    amount = fields.Monetary("Amount", currency_field='currency_id', tracking=True, required=True, readonly=True, copy=False, states={'draft': [('readonly', False)], 'submit': [('readonly', False)]})
